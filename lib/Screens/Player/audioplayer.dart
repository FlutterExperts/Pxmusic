import 'dart:async';
import 'package:pxmusic/CustomWidgets/downloadButton.dart';
import 'package:pxmusic/CustomWidgets/gradientContainers.dart';
import 'package:pxmusic/CustomWidgets/like_button.dart';
import 'package:pxmusic/Helpers/playlist.dart';
import 'package:pxmusic/Services/audioService.dart';
...
import 'package:pxmusic/CustomWidgets/emptyScreen.dart';
import 'package:pxmusic/CustomWidgets/seekBar.dart';
        ...
        child: StreamBuilder<QueueState>(
            ...
            builder: (context, snapshot) {
              ...
              ? Image(image: FileImage(File(queue[index].artUri.toFilePath())))
                  : CachedNetworkImage(
              errorWidget: (BuildContext context, _, __) => Image(
              image: AssetImage('assets/pxmusic_cover.png'),
              ),
              placeholder: (BuildContext context, _) => Image(
              image: AssetImage('assets/pxmusic_cover.png'),
              ),
